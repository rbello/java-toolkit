 ...
 */
package fr.evolya.javatoolkit.net.ftp.extrecognizers;

import java.util.ArrayList;

import fr.evolya.javatoolkit.net.ftp.FTPClient;
import fr.evolya.javatoolkit.net.ftp.FTPTextualExtensionRecognizer;
