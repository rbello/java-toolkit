...
public class CopyOfStatefullHttpContext implements HttpContext {
	...
	protected Map<String, List<HttpCookie>> _cookies = new HashMap<String, List<HttpCookie>>();
    ...
    protected static boolean isNotExpired(String cookieExpires) {
    	...
    	try {
    		 ...
    		 //DateFormat.getDateTimeInstance(DateFormat.FULL).parse(paramValue);
    		
    	    // TODO return (now.compareTo(dateFormat.parse(cookieExpires))) <= 0;
