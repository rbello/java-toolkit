...
package fr.evolya.javatoolkit.math.vecmath;
...
public class GMatrix implements java.io.Serializable, Cloneable {
    ...
    protected static void chase_up(double[] s, double[] e, int k, GMatrix v) {
	double f, g, r;
	double[] cosr = new double[1];
	double[] sinr = new double[1];
	int i;
    ...
    protected static void chase_across(double[] s, double[] e, int k, GMatrix u) {
	double f, g, r;
	double[] cosl = new double[1];
	double[] sinl = new double[1];
	int i;
