 ...
 */
public class DebugTreeViewController
	 ...
	 * Constructeur
	 */
	public DebugTreeViewController() {
	}
	
	public DebugTreeViewController(App app) {
		_mainApp = app;
	}
	...
	public DebugTreeView constructView() {
		...
		view.setTitle(_mainApp.getApplicationName() + " - DebugTreeView");
		...
		AppTreeNode root = new AppTreeNode(_mainApp);
	...
	protected void bindNodeEvents(final DebugTreeView view, final DefaultMutableTreeNode node, boolean recursive) {
		...
		// Pour les noeuds qui repr�sentent des applications
