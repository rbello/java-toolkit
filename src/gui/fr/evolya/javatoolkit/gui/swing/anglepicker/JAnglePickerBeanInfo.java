 ...
 */
public class JAnglePickerBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class , null ); // NOI18N
        beanDescriptor.setDisplayName ( "Angle picker" );//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_angleStep = 5;
    private static final int PROPERTY_antialiasing = 6;
    ...
    private static final int PROPERTY_circleRadius = 13;
    private static final int PROPERTY_clockwiseAngle = 14;
    private static final int PROPERTY_colorAngleArea = 15;
    private static final int PROPERTY_colorAngleLine = 16;
    private static final int PROPERTY_colorBackground = 17;
    private static final int PROPERTY_colorBorder = 18;
    private static final int PROPERTY_colorCircle = 19;
    private static final int PROPERTY_colorModel = 20;
    private static final int PROPERTY_colorReference = 21;
    ...
    private static final int PROPERTY_cursorClickedInside = 26;
    private static final int PROPERTY_cursorReleasedInside = 27;
    ...
    private static final int PROPERTY_enabled = 33;
    ...
    private static final int PROPERTY_margin = 68;
    ...
    private static final int PROPERTY_primaryStepTick = 81;
    private static final int PROPERTY_primaryStepTickSize = 82;
    private static final int PROPERTY_referenceAngleShift = 83;
    ...
    private static final int PROPERTY_secondStepTick = 87;
    private static final int PROPERTY_secondStepTickSize = 88;
    private static final int PROPERTY_showAngleArea = 89;
    private static final int PROPERTY_showing = 90;
    private static final int PROPERTY_showReference = 91;
    ...
    private static final int PROPERTY_valueDeg = 100;
    private static final int PROPERTY_valueRad = 101;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_angleStep] = new PropertyDescriptor ( "angleStep", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getAngleStep", "setAngleStep" ); // NOI18N
            properties[PROPERTY_angleStep].setPreferred ( true );
            properties[PROPERTY_angleStep].setShortDescription ( "To force an angle step, in degrees" );
            properties[PROPERTY_antialiasing] = new PropertyDescriptor ( "antialiasing", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isAntialiasing", "setAntialiasing" ); // NOI18N
            properties[PROPERTY_antialiasing].setPreferred ( true );
            properties[PROPERTY_antialiasing].setShortDescription ( "Enable or disabled antialiasing when painting the component" );
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_circleRadius] = new PropertyDescriptor ( "circleRadius", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getCircleRadius", "setCircleRadius" ); // NOI18N
            properties[PROPERTY_circleRadius].setPreferred ( true );
            properties[PROPERTY_circleRadius].setShortDescription ( "Radius un pixel of the input circle" );
            properties[PROPERTY_circleRadius].setBound ( true );
            properties[PROPERTY_clockwiseAngle] = new PropertyDescriptor ( "clockwiseAngle", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isClockwiseAngle", "setClockwiseAngle" ); // NOI18N
            properties[PROPERTY_clockwiseAngle].setPreferred ( true );
            properties[PROPERTY_clockwiseAngle].setShortDescription ( "If true, angle direction is clockwise" );
            properties[PROPERTY_colorAngleArea] = new PropertyDescriptor ( "colorAngleArea", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getColorAngleArea", "setColorAngleArea" ); // NOI18N
            properties[PROPERTY_colorAngleArea].setPreferred ( true );
            properties[PROPERTY_colorAngleArea].setShortDescription ( "Color of the angle area" );
            properties[PROPERTY_colorAngleLine] = new PropertyDescriptor ( "colorAngleLine", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getColorAngleLine", "setColorAngleLine" ); // NOI18N
            properties[PROPERTY_colorAngleLine].setPreferred ( true );
            properties[PROPERTY_colorAngleLine].setShortDescription ( "Color of the current angle reference" );
            properties[PROPERTY_colorBackground] = new PropertyDescriptor ( "colorBackground", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getColorBackground", "setColorBackground" ); // NOI18N
            properties[PROPERTY_colorBackground].setPreferred ( true );
            properties[PROPERTY_colorBackground].setShortDescription ( "Color of the component background" );
            properties[PROPERTY_colorBorder] = new PropertyDescriptor ( "colorBorder", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getColorBorder", "setColorBorder" ); // NOI18N
            properties[PROPERTY_colorBorder].setPreferred ( true );
            properties[PROPERTY_colorBorder].setShortDescription ( "Color of the exterior border of the circle, ticks and reference line" );
            properties[PROPERTY_colorCircle] = new PropertyDescriptor ( "colorCircle", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getColorCircle", "setColorCircle" ); // NOI18N
            properties[PROPERTY_colorCircle].setPreferred ( true );
            properties[PROPERTY_colorCircle].setShortDescription ( "Background color of the input circle" );
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_colorReference] = new PropertyDescriptor ( "colorReference", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getColorReference", "setColorReference" ); // NOI18N
            properties[PROPERTY_colorReference].setPreferred ( true );
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorClickedInside] = new PropertyDescriptor ( "cursorClickedInside", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isCursorClickedInside", "setCursorClickedInside" ); // NOI18N
            properties[PROPERTY_cursorReleasedInside] = new PropertyDescriptor ( "cursorReleasedInside", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isCursorReleasedInside", "setCursorReleasedInside" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_enabled].setPreferred ( true );
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_margin] = new PropertyDescriptor ( "margin", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getMargin", "setMargin" ); // NOI18N
            properties[PROPERTY_margin].setPreferred ( true );
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_primaryStepTick] = new PropertyDescriptor ( "primaryStepTick", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getPrimaryStepTick", "setPrimaryStepTick" ); // NOI18N
            properties[PROPERTY_primaryStepTick].setPreferred ( true );
            properties[PROPERTY_primaryStepTick].setShortDescription ( "Step in degrees for ticks" );
            properties[PROPERTY_primaryStepTickSize] = new PropertyDescriptor ( "primaryStepTickSize", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getPrimaryStepTickSize", "setPrimaryStepTickSize" ); // NOI18N
            properties[PROPERTY_primaryStepTickSize].setPreferred ( true );
            properties[PROPERTY_primaryStepTickSize].setShortDescription ( "Size in pixel of ticks" );
            properties[PROPERTY_referenceAngleShift] = new PropertyDescriptor ( "referenceAngleShift", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getReferenceAngleShift", "setReferenceAngleShift" ); // NOI18N
            properties[PROPERTY_referenceAngleShift].setPreferred ( true );
            properties[PROPERTY_referenceAngleShift].setShortDescription ( "Shift in degrees of north reference" );
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_secondStepTick] = new PropertyDescriptor ( "secondStepTick", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getSecondStepTick", "setSecondStepTick" ); // NOI18N
            properties[PROPERTY_secondStepTick].setPreferred ( true );
            properties[PROPERTY_secondStepTick].setShortDescription ( "Step in degrees for ticks" );
            properties[PROPERTY_secondStepTickSize] = new PropertyDescriptor ( "secondStepTickSize", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getSecondStepTickSize", "setSecondStepTickSize" ); // NOI18N
            properties[PROPERTY_secondStepTickSize].setPreferred ( true );
            properties[PROPERTY_secondStepTickSize].setShortDescription ( "Size in pixel of ticks" );
            properties[PROPERTY_showAngleArea] = new PropertyDescriptor ( "showAngleArea", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isShowAngleArea", "setShowAngleArea" ); // NOI18N
            properties[PROPERTY_showAngleArea].setPreferred ( true );
            properties[PROPERTY_showAngleArea].setShortDescription ( "If true, show the area covered by the current angle" );
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_showReference] = new PropertyDescriptor ( "showReference", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isShowReference", "setShowReference" ); // NOI18N
            properties[PROPERTY_showReference].setPreferred ( true );
            properties[PROPERTY_showReference].setShortDescription ( "If true, show the 0° angle reference" );
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_valueDeg] = new PropertyDescriptor ( "valueDeg", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getValueDeg", "setValueDeg" ); // NOI18N
            properties[PROPERTY_valueRad] = new PropertyDescriptor ( "valueRad", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getValueRad", "setValueRad" ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "getY", null ); // NOI18N
        }
    ...
    private static final int EVENT_angleListener = 1;
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_angleListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "angleListener", fr.evolya.javatoolkit.gui.swing.anglepicker.listener.AngleListener.class, new String[] {"angleChanging", "angleChanged"}, "addAngleListener", "removeAngleListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_updateUI141] = new MethodDescriptor(fr.evolya.javatoolkit.gui.swing.anglepicker.JAnglePicker.class.getMethod("updateUI", new Class[] {})); // NOI18N
    ...
    private static String iconNameC16 = "/inca/ihm/swing/anglepicker/icon/ico_col16.png";//GEN-BEGIN:Icons
    private static String iconNameC32 = "/inca/ihm/swing/anglepicker/icon/ico_col32.png";
    private static String iconNameM16 = "/inca/ihm/swing/anglepicker/icon/ico_bw16.png";
    private static String iconNameM32 = "/inca/ihm/swing/anglepicker/icon/ico_bw32.png";//GEN-END:Icons
